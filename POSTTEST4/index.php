...
<body>
    ...
    <section class = 'hero' >
        ...
        <div class="inside-hero">
            ...
            <div class="poster">
                <img src="asset/dots.jpg" alt="Descendants Of The Sun">
            </div>
        </div>
    </section>
        ...
        <table width="1263px">
                ...
                <tr>
                    <td>
                        <div class="cafe_minamdang">
                            <img src="asset/cm.jpeg" alt="Cafe Minamdang">
                    ...
                    <td>
                        <div class="cloy">
                            <img src="asset/CLOY.jpeg" alt="Crush Landing on You">
                    ...
                    <td>
                        <div class="dr_cha">
                            <img src="asset/dr.cha.jpg" alt="dr. Cha">
                            <h3>dr. Cha</h3>
            ...
            <div class="tabel2">
                <tr>
                    <td>
                        <div class="gbm">
                            <img src="asset/gbm.jpg" alt="Good Bad Mother">
                    ...
                    <td>
                        <div class="tfto">
                            <img src="asset/tfto.jpeg" alt="Twenty-Five Twenty-One">
                    ...
                    <td>
                        <div class="hp">
                            <img src="asset/hp.jpg" alt="Hospital Playlist">
            ...
            <div class="tabel3">
                <tr>
                    <td>
                        <div class="ic">
                            <img src="asset/ic.jpeg" alt="Itaewon Class">
                            <h3>Itaewon Class</h3>
                    ...
                    <td>
                        <div class="moving">
                            <img src="asset/moving.jpeg" alt="Moving">
                            <h3>Moving</h3>
                    ...
                    <td>
                        <div class="obm">
                            <img src="asset/obm.jpg" alt="Our Beloved Summer">
            ...
            <div class="tabel4">
                <tr>
                    <td>
                        <div class="start_up">
                            <img src="asset/start up.jpeg" alt="Start Up">
                            <h3>Start Up</h3>
                    ...
                    <td>
                        <div class="tuc">
                            <img src="asset/tuc.jpeg" alt="The Uncanny Counter">
                    ...
                    <td>
                        <div class="ttd">
                            <img src="asset/ttd.jpeg" alt="Throught The Darkness">
