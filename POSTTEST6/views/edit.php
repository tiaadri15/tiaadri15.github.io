...
if (isset($_POST['ubah'])) {
    ...
    if (move_uploaded_file($tmp, "../img/".$gmbr)) {
        ...
        $result = mysqli_query($conn, "UPDATE drama_korea SET gambar='$gmbr',judul_drama='$judul_drama', genre='$genre', tahun_rilis='$tahun_rilis', jumlah_episode='$jumlah_episode' WHERE id_drama = $id_drama");
