...
<body>
    ...
    <header id="header">
        ...
        <ul>
            <li><div class="dropdown">
                    ...
                    require "../include/koneksi.php";
                        if(isset($_SESSION['username'])){
                            echo '<a href="profil.php">Profile</a><br>';
            ...
            <li><a href="drama.php"><i class="fa-solid fa-clapperboard"></i> Drama</a></li>
    ...
    <section class = 'hero' >
        ...
        <div class="inside-hero">
            <div class="title">
                ...
                <div class="btn1">
                    <a href="https://www.viu.com/ott/id/id/vod/1755828/Descendants-of-The-Sun?utm_source=viu_web&utm_medium=vod_share_btn&utm_campaign=2514cbe6-c657-4bd3-9b10-4cf99fdbd4b3&utm_content=link"><i class="fas fa-play"></i>Watch Now</a>
